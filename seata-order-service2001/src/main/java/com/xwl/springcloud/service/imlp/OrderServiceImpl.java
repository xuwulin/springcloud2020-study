package com.xwl.springcloud.service.imlp;

import com.xwl.springcloud.dao.OrderDao;
...
public class OrderServiceImpl implements OrderService {
     ...
     */
    @Override
    @GlobalTransactional(name = "fsp-create-order", rollbackFor = Exception.class) // name随便取，rollbackFor = Exception.class表示发生异常统统回滚，可以是其他异常如NullPointerException等
